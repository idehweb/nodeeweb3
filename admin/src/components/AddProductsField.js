...
// console.log('selectedChoices',selectedChoices)
  return (
    <>
      <ArrayInput
        fullWidth
        source={source} label={translate("resources.order.card")}>
            ...
            {({ scopedFormData={}, getSource, ...rest }) => {
              return <div className={"row mb-20"}>
                ...
                <div className={"col-md-3"}>
                  {scopedFormData.product_id && <TextInput
                    source={getSource("_id")}
                    defaultValue={scopedFormData ? returnDefaultValue(scopedFormData.product_id,'_id') : 0}
                    label={translate("resources.order._id")}
                    className={"width100 mb-20 ltr"} fullWidth/>}
                    {scopedFormData.product_id && <TextInput
                    source={getSource("title")}
                    defaultValue={scopedFormData ? returnDefaultValue(scopedFormData.product_id,'title') : 0}
                    label={translate("resources.order.title")}
                    className={"width100 mb-20 ltr"} fullWidth/>}


                  {!scopedFormData.product_id && <AutocompleteInput
                ...
                <div className={"col-md-3"}>
                  ...
                  {scopedFormData.product_id && <NumberInput
                    defaultValue={1}
                    source={getSource("count")} label={translate("resources.order.count")}
                    className={"width100 mb-20 ltr"} fullWidth/>}
                ...
                <div className={"col-md-3"}>
                  {scopedFormData.product_id && <TextInput
                    ...
                    className={"ltr"}
                    defaultValue={scopedFormData ? returnDefaultValue(scopedFormData.product_id, "price") : 0}
                ...
                <div className={"col-md-3"}>
                  {scopedFormData.product_id && <TextInput
                    fullWidth
                    // record={scopedFormData}
                    defaultValue={scopedFormData ? returnDefaultValue(scopedFormData.product_id, "salePrice") : 0}
