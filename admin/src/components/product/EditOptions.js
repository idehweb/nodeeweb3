...
export default (props) => {
  ...
  // const [combinations, setCombinations] = useState(valuescombinations || []);
  // const [type, setType] = useState(valuestype);
  const [change, setChanger] = useState(true);
  // const [TheformData, setTheformData] = useState(valuesformData);
  // const [selectS, setSelectS] = useState([true, true]);
  ...
  if (valuestype !== 'variable') return null;
