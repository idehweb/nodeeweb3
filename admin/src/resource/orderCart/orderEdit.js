              ...
              <Datagrid optimized>
                <FunctionField
                  ...
                  render={(record) => {
                    ...
                    return (
                      <Link target="_blank" to={`/product/${link}/show`}>
                        {record.title.fa}
                      </Link>
                    );
                  }}
...
const Form = ({ children, ...props }) => {
  return (
    <SimpleForm {...props} onSubmit={save} className={'d-flex'}>
      <NumberInput source="amount" label="پرداختی" className={'mb-20 ltr'} />
                      ...
                      {record.customer && (
                        <div>
                          ...
                          {record.customer.phoneNumber && (
                            <Link
                              target="_blank"
                              to={`/customer/${record.customer._id}`}>
                              {record.customer.phoneNumber}
                            </Link>
                          )}
                        </div>
    ...
    filters={
      <Filter {...props}>
        ...
        <SelectInput
          ...
          alwaysOn
        />
        {/*<SelectInput source="paymentStatus" label={'وضعیت پرداخت'}  emptyValue=""*/}
