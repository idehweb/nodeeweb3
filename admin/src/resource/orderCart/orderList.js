                           ...
                           render={record => (
                             <div className='theDate'>
                               {record.customer && <div>{record.customer.firstName && <div>
                                 ...
                                 <Link target="_blank" to={`/customer/${record.customer._id}`}>{record.customer.phoneNumber}</Link>}
    ...
    <List
      ...
      filters={
        <Filter {...props}>
          ...
          <SelectInput source="status" label={translate("resources.order.orderNumber")} emptyValue="" choices={OrderStatus()}
                       alwaysOn/>
        </Filter>
