      ...
      <div flush="true" className={'card-add'}>
        {card &&
          ...
          card.map((item, idx) => {
            ...
            return (
              <ListGroupItem key={idx} className="d-flex px-3 border-0 wedkuhg">
                ...
                <div className={'flex-8 mr-2'}>
                  ...
                  {item.price && item.salePrice && (
                    <div className={'prc'}>
                      ...
                      <del className={'ml-2'}>{returnPrice(item.price)}</del>
                    </div>
                  )}
                </div>
        ...
        {card && card.length > 0 && (
          <Link
            ...
            <span className={'juytrftyu'}>
              {tsum && <span className={'ttl gtrf'}>{returnPrice(tsum)}</span>}
            </span>
          </Link>
        )}
        {!card ||
