...
const Component = (props) => {
  ...
  const returnArrayOfComponent = (component) => {
    ...
    if (
      ...
      component.settings.general.fields &&
      component.settings.general.fields.colCount
    ) {
      ...
      {!componentForSetting && (
        <>
          <div className={' component name-' + component.name}>
            <div
              className={
                'npb-d-flex ' + (component.addable ? 'border-bottom' : '')
              }>
              <div style={{ direction: 'ltr' }}>
                ...
                <label className={'component-id'} style={{ direction: 'ltr' }}>
                  {'#' + component.id}
                </label>
                {text && (
                  <label
              ...
              <span className={'npb-settings'}>
                {Boolean(index) && (
                  <Button
                    onClick={() => moveContent(index, index - 1, address)}>
                    <ArrowUpwardIcon />
                  </Button>
                )}
          ...
          {component.addable && (
            <div className={'add-part name-' + component.name}>
