                            ...
                            if (HC.type === 'object') {
                              ...
                              return (
                                <TableCell
                                  ...
                                  {!HC.keys &&
                                    row[HC.id] &&
                                    typeof row[HC.id] == 'object' &&
                                    !(row[HC.id] instanceof Array) &&
                                    Object.keys(row[HC.id]).map((key) => {
                                      return (
                                        <div>
                                          {JSON.stringify(row[HC.id][key])}
                                        </div>
                                      );
                                    })}
                                  {!HC.keys &&
                                ...
                                <TableCell
                                  ...
                                  {HC.delete ? (
                                    <Link
                                      ...
                                      theme="danger"
                                      className={
                                        'btn btn-primary ml-2 mr-2 btn-outline-danger btn-sm'
                                      }
                                      size="sm"
                                      to={
                                        '/admin/' +
                                  ...
                                  {HC.pageBuilder ? (
                                    <Link
                                      ...
                                      size="sm"
                                      className={
                                        'btn btn-primary ml-2 mr-2 btn-outline-warning btn-sm'
                                      }
                                      to={
                                        '/admin/' +
                                        model +
        ...
        {rows && count > 0 && (
          <TablePagination
            ...
            onPageChange={(e, newPage) =>
              handleChangePage(e, newPage, { renewData, rowsPerPage })
            }
