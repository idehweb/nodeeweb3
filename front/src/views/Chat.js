  ...
  return (
    <Container fluid className="main-content-container fghjkjhgf">
      <Row className="relative mt-3 mb-3">
        <Col>
          <Link to={'/contacts'}>
            <Button className={'fixed buttop'}>
              <RecentActorsIcon />
            </Button>
          </Link>

          <Button onClick={useContacts} className={'fixed buttop lefter'}>
            <AddCommentIcon />
          </Button>
        </Col>
      </Row>
        ...
        <Col>
          <form onSubmit={sendPing}>
            <input
              ...
              value={inputValue}
            />
            <Button onClick={sendPing} className={'fixed but'}>
              <SendIcon />
            </Button>
          </form>
        </Col>
